...
export default function BinSelector() {
  ...
  return (
    <div className="bg-gray-100 flex flex-col gap-6 text-black w-full mt-10">
      <h1 className="text-3xl md:text-4xl  font-bold text-center px-8">
      ...
      <div className="w-full flex flex-col gap-10 justify-center items-center max-w-7xl px-8 mx-auto">
        ...
        <div className="flex bg-white rounded-2xl py-2 justify-center items-center">
          <p className="font-bold text-base md:text-lg py-2 md:px-4">
            Bin units:
          </p>
          {binOptions.map((num) => (
            <button
      ...
      <div className="w-full bg-grisT text-grisSubP text-base md:text-lg py-10 my-20 px-8 md:px-20 lg:px-52">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 justify-center max-w-7xl px-8 mx-auto">
          <div>
            <p>
              Dimensions and aggregate dosing systems that comply with
              ...
              <br />
              Built from high-strength steel to withstand heavy loads and resist
              deformation under demanding working conditions. <br />
              <br />
          ...
          <div>
            <p>
              High-quality equipment built for durability and efficient hot-mix
              production. Featuring reinforced steel structures and integrated
              vibration systems, our bin units ensure steady aggregate flow,
              minimal clogging, and reduced wear. Designed for continuous
              operation, they deliver consistent, reliable performance with low
              maintenance—even under the toughest jobsite conditions. <br />
              <br />
              Equipped with precision-controlled aggregate dosing mechanisms
              they guarantee accurate and uniform material dosing throughout
              production process.
            </p>
          </div>
        </div>
