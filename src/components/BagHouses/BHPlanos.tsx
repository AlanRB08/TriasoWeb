    ...
    <div className="w-full flex flex-col items-center justify-center">
      ...
      >
        ...
        <div className="w-full px-8 lg:px-8 mt-14">
          ...
          <div id="options" ref={optionsRef} className="w-full"></div>
                  ...
                  >
                    <div className="flex flex-col items-start justify-center gap-4 text-white w-full">
                      ...
                      >
                        ...
                        <li>
                          Access doors and inspection hatches for fast servicing
                        </li>
                        <li>
                          Factory-installed bag powder — no startup waiting
                          time.
                        </li>
                        <li>
                          99.99% filtration and energy-efficient cleaning from
                          startup
                        </li>
                        <li>
                          Self-contained, integrated systems for portable or
                          stationary plants.
                        </li>
                      </ul>
                    </div>
                      ...
                      >
                        ...
                        <li className="list-none">
                          <ul className="list-disc ml-10">
                            <li>
                              Exhaust damper with electric actuator for
                        ...
                        <li>
                          Gas extractor with centrifugal separation removes up
                          to 70% of dust before filtration.
                        </li>
                        <li>
                          Knockout chamber and internal baffles ensure smooth
                          airflow and bag protection.
                        </li>
                        <li>
                          Exhaust fan with curved blades operates quietly and
                          efficiently
                        </li>
                        <li>
                          Supersonic 3D-printed carbon-alloy nozzles for
                          pulse-jet cleaning.
                        </li>
                ...
                <div className="w-full grid grid-cols-1 md:grid-cols-4 mt-0 md:mt-10 justify-center items-start">
                  ...
                  <div className="flex flex-col items-start justify-center gap-4 text-white col-span-1">
                    ...
                    >
                      ...
                      <li>
                        Mounted on standard transport chassis with triple axles
