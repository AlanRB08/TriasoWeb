                ...
                <div className='flex flex-col md:grid md:grid-cols-4 justify-center items-center'>
                            ...
                            <ul className={`transition-all duration-500 md:mb-0 overflow-hidden ml-6 list-disc list-inside ${openSections.C1_1 ? "max-h-96 opacity-1 mb-4" : "max-h-0 opacity-0"} md:max-h-full md:opacity-100 md:block`}>
                                ...
                                <li className="list-none">
                                    <ul className="list-disc ml-10">
                                        <li>
                                            1,000,000 and 2,400,000 Btu/hr capacity
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div className='flex flex-col items-start justify-between h-full col-span-1 w-full order-3 md:order-3' id='column2' ref={columnGrid2}>
                        ...
                        <div className='w-full flex justify-between border-b border-b-white'>
                                ...
                                <li>Three inches thermal insulation minimizes heat and surface temperature.</li>
                ...
                <div className='flex w-full justify-start md:justify-center items-end my-10 overflow-x-auto'>
                    <div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center w-full h-[60px]'>
                            ...
                            <p className='text-white lg:text-lg text-base w-full text-center mx-4' data-imperial='268.22 cm' data-metric='8.8 ft'>
                                {unit === 'metric'
                    ...
                    <div className='flex flex-col items-center justify-end w-[90px] h-[250px]'>
                        ...
                        <div className='my-3'>
                            <p className='text-white text-lg' data-imperial='381 cm' data-metric='12.75 ft'>{unit === 'metric'
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center w-full h-[60px]'>
                            ...
                            <p className='text-white lg:text-lg text-base w-full text-center mx-4' data-imperial='722.37 cm' data-metric='23.7 ft'>
                                {unit === 'metric'
                        ...
                        <div className='h-[250px] min-w-[800px] flex justify-center items-center'>
                            <img src={ATR1.src} alt="Dinámica con paneles" className='h-[250px] w-auto'/>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='w-full flex justify-between border-b border-b-white'>
                        ...
                        <div className={`transition-all duration-500 md:mb-0 overflow-hidden list-inside ${openSections.C4_1 ? "max-h-96 opacity-1 mb-4" : "max-h-0 opacity-0"} md:max-h-full md:opacity-100 md:block`}>
                            ...
                            <div className='flex justify-between'>
                                <h1>Capacity:</h1>
                                <p>
                                    {`${activeData?.dimensions.capacity ?? ''} L`}
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className='flex flex-col items-start justify-between h-full col-span-1 w-full order-3 md:order-3'>
                ...
                <div className='flex w-full justify-start md:justify-center items-end my-10 overflow-x-auto'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <div className='h-[250px] min-w-[800px] flex justify-center items-center'>
                            <img src={ATR2.src} alt="Dinámica con paneles" className='h-[250px] w-auto'/>
                        </div>
                    </div>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-start w-full md:mt-10 md:gap-10'>
                ...
                <div className='flex w-full justify-start md:justify-center items-end my-10 overflow-x-auto'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <div className='h-[250px] min-w-[900px] flex justify-center items-center'>
                            <img src={ATR3.src} alt="Dinámica con paneles" className='h-[250px] w-auto'/>
                        </div>
                    </div>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-start w-full md:mt-10 md:gap-10'>
                ...
                <div className='flex w-full justify-start md:justify-center items-end my-10 overflow-x-auto'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <div className='h-[250px] min-w-[980px] flex justify-center items-center'>
                            <img src={ATR4.src} alt="Dinámica con paneles" className='h-[250px] w-auto'/>
                        </div>
                    </div>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-start w-full md:mt-10 md:gap-10'>
                ...
                <div className='flex w-full justify-start md:justify-center items-end my-10 overflow-x-auto'>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        ...
                        <div className='h-[300px] min-w-[644px] flex justify-center items-center'>
                            <img src={ATR5.src} alt="Dinámica con paneles" className='h-[300px] w-auto'/>
                        </div>
                    </div>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-center items-start w-full md:mt-10 md:gap-10'>
