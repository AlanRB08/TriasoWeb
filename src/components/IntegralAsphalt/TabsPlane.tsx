...
const TabsPlane = () => {
  const [activeTab, setActiveTab] = useState(1); // 1, 2 o 3
      ...
      <div className="w-full border border-white mt-20">
                ...
                <div className='flex justify-center items-end my-10'>
                    <div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center w-full h-[60px]'>
                            ...
                            <p className='text-white lg:text-lg text-base w-full text-center mx-4'>290.5 CM</p>
                    ...
                    <div className='flex flex-col items-center justify-end w-[90px] h-[353px]'>
                        ...
                        <div className='my-3'>
                            <p className='text-white text-lg'>421 CM</p>
                        </div>
                    ...
                    <div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center w-full h-[60px]'>
                            ...
                            <p className='text-white lg:text-lg text-base w-full text-center mx-4'>876 CM</p>
                            <div className='border-dotted border-r border-r-white h-full w-full flex items-center justify-center'>
                                <div className='bg-white h-[1px] w-full relative'>
                                    <div className='absolute right-0 top-1/2 transform -translate-y-1/2'>
                                    <svg 
        ...
        {activeTab === 2 && (
          <div className="text-white">
            <h3>Contenido del Tab 2</h3>
            <p>Este es el contenido que se muestra cuando el Tab 2 está activo.</p>
          </div>
        )}

        {activeTab === 3 && (
          <div className="text-white">
            <h3>Contenido del Tab 3</h3>
            <p>Este es el contenido que se muestra cuando el Tab 3 está activo.</p>
          </div>
        )}
      </div>
    </div>
